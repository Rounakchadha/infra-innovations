...
import { MapPin, Phone, Mail, Clock, Send, CheckCircle, XCircle, Twitter, Instagram, Linkedin, MessageCircle } from 'lucide-react';

const WHATSAPP_NUMBER = '919415011227';
...
const ContactPage = () => {
  ...
  useEffect(() => {
    document.title = "Contact Us - Infra Innovations";
    ...
    const contactSchema = {
      ...
      "breadcrumb": {
        "@type": "BreadcrumbList",
        "itemListElement": [
          { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.infra.org.in/" },
          { "@type": "ListItem", "position": 2, "name": "Contact", "item": "https://www.infra.org.in/contact" }
        ]
      },
      "mainEntity": {
        "@type": "LocalBusiness",
        ...
        "email": ["innovvations@gmail.com"],
        "openingHours": ["Mo-Fr 09:00-18:00", "Sa 10:00-16:00"],
        "geo": { "@type": "GeoCoordinates", "latitude": "26.8732754", "longitude": "80.9899283" }
      }
    };
    ...
    try {
      const res = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          subject: `New Inquiry from ${formData.name} — Infra Innovations`,
  ...
  const inputClass = "w-full px-4 py-3 bg-black border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-400/20 transition-all duration-300 min-h-[44px] touch-manipulation";
            ...
            <section className="bg-gray-900 border border-gray-700 rounded-2xl p-8 shadow-lg">
              ...
              {status === 'success' ? (
                ...
                <div className="text-center py-12" role="alert" aria-live="polite">
                  ...
                  <p className="text-gray-300 mb-4">Please try again, or reach us directly at:</p>
                  <a href="mailto:innovvations@gmail.com" className="text-blue-400 hover:text-blue-300">
                ...
                <form onSubmit={handleSubmit} className="space-y-6" noValidate>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="text" id="name" name="name" value={formData.name} onChange={handleInputChange}
                        required autoComplete="name" className={inputClass} placeholder="Your full name" />
                    </div>
                    <div>
                      <label htmlFor="email" className="block text-sm font-semibold text-white mb-2">Email Address *</label>
                      <input type="email" id="email" name="email" value={formData.email} onChange={handleInputChange}
                        required autoComplete="email" className={inputClass} placeholder="your.email@example.com" />
                    </div>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleInputChange}
                        autoComplete="tel" className={inputClass} placeholder="+91" />
                    </div>
                    <div>
                      <label htmlFor="company" className="block text-sm font-semibold text-white mb-2">Company/Organization</label>
                      <input type="text" id="company" name="company" value={formData.company} onChange={handleInputChange}
                        autoComplete="organization" className={inputClass} placeholder="Your company name" />
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-blue-600 hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed text-white font-semibold py-4 px-8 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center group min-h-[44px] touch-manipulation"
            ...
            <section className="space-y-8">
              ...
              <div className="space-y-6" itemScope itemType="https://schema.org/LocalBusiness">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <address className="text-gray-300 not-italic" itemProp="address" itemScope itemType="https://schema.org/PostalAddress">
                        ...
                        <span itemProp="streetAddress">401, II Floor<br />Sahara Trade Centre<br />Ayodhya Road</span><br />
                ...
                <a
                  ...
                  className="block bg-gray-900 border border-gray-700 hover:border-green-500 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group"
                >
                  <div className="flex items-start space-x-4">
                    <div className="bg-green-600 p-3 rounded-lg flex-shrink-0 group-hover:bg-green-500 transition-colors">
                      <MessageCircle className="w-6 h-6 text-white" aria-hidden="true" />
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-white mb-2">WhatsApp Us</h3>
                      <p className="text-gray-300 group-hover:text-green-400 transition-colors">+91 9415011227</p>
                      <p className="text-gray-500 text-sm mt-1">Tap to open WhatsApp chat</p>
                    </div>
                  </div>
                </a>
                ...
                <div className="bg-gray-900 border border-gray-700 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:innovvations@gmail.com" className="hover:text-blue-400 transition-colors text-gray-300 block" itemProp="email">
                        innovvations@gmail.com
                      </a>
                    </div>
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="rounded-xl overflow-hidden shadow-lg border border-gray-700">
            <iframe
              ...
              title="Infra Innovations Office Location"
            />
          </div>
          <div className="text-center mt-6">
            ...
            <p className="text-gray-400 text-sm mt-2">Click on the map to get directions or view in Google Maps</p>
          </div>
        </div>
      </section>
